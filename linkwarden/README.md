...
[linkwarden](https://linkwarden.app/) 是一个协作式书签管理器，用于收集、组织和保存网页和文章。
这个插件基于他们的 Docker 镜像。
...
"NEXT_PUBLIC_AUTHENTIK_ENABLED": 如果设置为 true，Authentik 将被启用，你将需要定义以下变量。
"AUTHENTIK_CUSTOM_NAME": 可选地设置一个自定义提供者名称。（按钮上的名称）
"AUTHENTIK_ISSUER": 这是“OpenID 配置发行者”，在提供者概览中显示。注意，你必须删除 URL 结尾的“/”。应该看起来像： `https://authentik.my-doma.in/application/o/linkwarden`
...
完整选项列表可以在这里查看：https://docs.linkwarden.app/self-hosting/environment-variables
