...
一套基于浏览器的工具，适用于D&D 5e的玩家和地下城主。从5etools GitHub下载图片。没有图片或内容在jdeath的仓库中托管/发布。不提供支持，因为Home Assistant Addon创建者不使用这个。自托管图片可能落后于5etools网站。图片是4 GB，所以安装时间会很长，请耐心等待。
