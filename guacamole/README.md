...
![Arch](https://img.shields.io/badge/dynamic/json?color=success&label=架构&query=%24.arch&url=https%3A%2F%2Fraw.githubusercontent.com%2Falexbelgium%2Fhassio-addons%2Fmaster%2Fguacamole%2Fconfig.json)
...
[Apache Guacamole](https://guacamole.apache.org/) 是一个无客户端的远程桌面网关。它支持标准协议，如 VNC、RDP 和 SSH。这个容器只是使用官方或第三方 HTML5 前端所需的 backend 服务器组件。

这个插件基于以下 Docker 镜像：[https://github.com/abesnier/docker-guacamole](https://github.com/abesnier/docker-guacamole)
