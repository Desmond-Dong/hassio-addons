...
1. 点击下方 Home Assistant 我的 add-on 商店按钮。
1. 点击 "安装" 按钮来安装此 add-on。
1. 启动 add-on。
1. 检查 add-on 的日志，查看是否一切顺利。

<a href="https://my.home-assistant.io/redirect/supervisor_addon/?addon=local_collabora" target="_blank"><img src="https://my.home-assistant.io/badges/supervisor_addon.svg" alt="打开你的 Home Assistant 实例并显示添加 add-on 仓库对话框"/></a>
...
- **自定义脚本**: 参考 [在 Addons 中运行自定义脚本](https://github.com/alexbelgium/hassio-addons/wiki/Running-custom-scripts-in-Addons)
- **环境变量**: 参考 [向你的 Addon 添加环境变量](https://github.com/alexbelgium/hassio-addons/wiki/Add-Environment-variables-to-your-Addon)
