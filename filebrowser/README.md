...
Webui 可以在 <http://homeassistant:port> 上找到，其中 port 是你在插件选项中映射到 8080 的端口。
...
localdisks: sda1 #将你的硬盘硬件名称挂载到此处，用逗号分隔，或其标签。例如。 sda1, sdb1, MYNAS...
...
1. 启动插件。
1. 检查插件的日志，看看是否一切正常。
1. 仔细配置插件以满足你的偏好，请参阅 [官方文档](https://filebrowser.org/configuration) 获取相关信息。
