## ⚠️ 开启问题 : [🐛 [Immich] 没有从 Immich 1.132.0 之前的版本升级到 1.137.0 或更高版本的路径 (于 2025-08-18 开启)](https://github.com/alexbelgium/hassio-addons/issues/2047) 由 [@efficiencynerd](https://github.com/efficiencynerd)
...
Webui 可在 `<你的 IP>:8080` 找到。PostgreSQL/MySQL 可以是内部的或外部的。
