## ⚠️ 开启问题 : [🐛 [Immich] 没有从 Immich 1.132.0 之前的版本升级到 1.137.0 或更高版本的路径 (开启于 2025-08-18)](https://github.com/alexbelgium/hassio-addons/issues/2047) 由 [@efficiencynerd](https://github.com/efficiencynerd)
## ⚠️ 开启问题 : [🐛 [immich] 创建缩略图的任务存在问题，使用 HA 插件无法解决分辨率 (开启于 2025-08-26)](https://github.com/alexbelgium/hassio-addons/issues/2072) 由 [@samimasad](https://github.com/samimasad)
# Home assistant 插件：immich

⚠️ 项目正在非常活跃地开发中。请期待出现错误和变化。不要将其作为存储您照片和视频的唯一方式！(来自开发者)
...
基于文件浏览器的 Web 应用。
这个插件基于 [docker 镜像](https://github.com/imagegenius/docker-immich) 的 imagegenius。

## 配置

Webui 可以在 `<your-ip>:8080` 找到。PostgreSQL/MySQL 可以是内部的也可以是外部的。
...
| `localdisks` | str | | 挂载本地驱动器 (例如，`sda1,sdb1,MYNAS`) |
| `networkdisks` | str | | 挂载 SMB 共享 (例如，`//SERVER/SHARE`) |
...
在 github 上创建问题，或在 [home assistant 的讨论区](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 上提问
