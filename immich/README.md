## ⚠️ Open Issue : [🐛 [Immich] 没有从 Immich 1.132.0 之前的版本升级到 1.137.0 或更高版本的路径 (已打开 2025-08-18)](https://github.com/alexbelgium/hassio-addons/issues/2047) by [@efficiencynerd](https://github.com/efficiencynerd)
## ⚠️ Open Issue : [🐛 [immich] 创建缩略图的作业存在问题，使用 HA 插件无法解决问题 (已打开 2025-08-26)](https://github.com/alexbelgium/hassio-addons/issues/2072) by [@samimasad](https://github.com/samimasad)
...
Web UI 可以在 `<your-ip>:8080` 找到。PostgreSQL/MySQL 可以是内部的，也可以是外部的。
