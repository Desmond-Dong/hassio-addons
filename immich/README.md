## 警告：打开问题：[🐛 [Immich] 没有从 Immich 1.132.0 之前的版本升级到 1.137.0 或更高版本的路径（于 2025-08-18 打开）](https://github.com/alexbelgium/hassio-addons/issues/2047) 由 [@efficiencynerd](https://github.com/efficiencynerd)
...
这个插件基于 [docker 镜像](https://github.com/imagegenius/docker-immich) 从 imagegenius。

## 配置

Web 界面可以在 `<你的 IP>:8080` 找到。PostgreSQL/MySQL 可以是内部的或外部的。
