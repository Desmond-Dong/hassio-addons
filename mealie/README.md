## ⚠️ Open Issue : [🐛 [Mealie] After updating Mealie to version 3.0.0, ingress is not working (opened 2025-07-12)](https://github.com/alexbelgium/hassio-addons/issues/1948) by [@djtail](https://github.com/djtail)
## ⚠️ Open Issue : [🐛 [Mealie] Recipe import from websites no longer working after 3.x upgrade (opened 2025-07-16)](https://github.com/alexbelgium/hassio-addons/issues/1962) by [@donverse](https://github.com/donverse)
## ⚠️ Open Issue : [🐛 Mealie unable to login after upgrade to 3.x (opened 2025-07-16)](https://github.com/alexbelgium/hassio-addons/issues/1964) by [@motionist](https://github.com/motionist)
...
警告：armv7 仅支持到 0.4.3 版本！它不会随着后续版本更新
...
Mealie 是一个自托管食谱管理和饮食计划工具，具有 RestAPI 后端和基于 Vue 的响应式前端应用程序，为整个家庭提供愉悦的用户体验。
...
- 启动插件。等待一段时间，检查日志中的任何错误。
- 打开 yourdomain.com:9090（其中 ":9090" 是插件中配置的端口）。
- 默认
...
完整的选项列表可以在以下链接查看：https://nightly.mealie.io/documentation/getting-started/installation/backend-config/
