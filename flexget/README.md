...
_感谢所有给我仓库星标的人！要星标它，请点击下面的图片，然后它就会出现在右上角。谢谢！_
...
FlexGet 是一个用于所有媒体的多功能自动化工具。请访问 https://flexget.com/

默认密码是 'homeassistant123'，或者可以在插件选项中设置
