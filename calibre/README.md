...
[Calibre](https://calibre-ebook.com/) 是一个强大且易于使用的电子书管理器。用户称其为杰出且必备的工具。它几乎可以做到一切，并超越了普通的电子书软件。它完全免费且开源，非常适合普通用户和计算机专家。
...
请查阅上游容器文档以获取更多信息：https://github.com/linuxserver/docker-calibre#application-setup
