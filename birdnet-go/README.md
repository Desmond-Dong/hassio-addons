## 警告：打开问题 : [🐛 [Birdnet-go] USB 麦克风在 UI 中可选择，但不工作（打开于 2025-03-12）](https://github.com/alexbelgium/hassio-addons/issues/1808) 由 [@melor](https://github.com/melor)
## 警告：打开问题 : [🐛 [BirdNET-Go] HA Ingress URL 没有重定向到带日期的 URL（打开于 2025-04-02）](https://github.com/alexbelgium/hassio-addons/issues/1830) 由 [@phobiac](https://github.com/phobiac)
...
音频片段文件夹可以存储在外部或 SMB 驱动器上，通过挂载它到插件选项中，然后指定路径而不是 "clips/"。例如，"/mnt/NAS/Birdnet/"
...
- config.yaml
可以使用 Filebrowser 插件在 /config/db21ed7f_birdnet-go/config.yaml 中配置额外的变量
