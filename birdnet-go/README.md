## ⚠️ 开启问题 : [🐛 [Birdnet-go] USB 麦克风在 UI 中可选择，但无法工作 (开启于 2025-03-12)](https://github.com/alexbelgium/hassio-addons/issues/1808) 由 [@melor](https://github.com/melor)
## ⚠️ 开启问题 : [🐛 [BirdNET-Go] HA Ingress URL 不会重定向到带日期的 URL (开启于 2025-04-02)](https://github.com/alexbelgium/hassio-addons/issues/1830) 由 [@phobiac](https://github.com/phobiac)
...
[![Starazers repo roster for @alexbelgium/hassio-addons](https://reporoster.com/stars/alexbelgium/hassio-addons)](https://github.com/alexbelgium/hassio-addons/stargazers)
...
[BirdNET-Go](https://github.com/tphakala/birdnet-go/tree/main) 是由 @tphakala 开发的 AI 解决方案，用于持续鸟类监测和识别。
...
您需要一个麦克风：要么使用连接到 HA 的麦克风，要么使用 RTSP 摄像头的音频流。

音频片段文件夹可以通过在插件选项中挂载外部或 SMB 驱动器来存储，然后指定路径而不是 "clips/"。例如，"/mnt/NAS/Birdnet/"
...
- config.yaml
可以使用 Filebrowser 插件在 /config/db21ed7f_birdnet-go/config.yaml 中配置 config.yaml 文件来配置其他变量
...
Home Assistant 集成说明可以在 [Birdnet-Go Addon: Home Assistant Integration](./HAINTEGRATION.md) 中找到
