## ⚠️ 开启问题 : [🐛 [Birdnet-go] USB 麦克风在 UI 中可选，但无法工作（2025-03-12 开启）](https://github.com/alexbelgium/hassio-addons/issues/1808) by [@melor](https://github.com/melor)
## ⚠️ 开启问题 : [🐛 [BirdNET-Go] HA Ingress URL 不会重定向到带日期的 URL（2025-04-02 开启）](https://github.com/alexbelgium/hassio-addons/issues/1830) by [@phobiac](https://github.com/phobiac)
...
[![捐赠](https://img.shields.io/badge/Buy%20me%20a%20coffee%20with%20Paypal%20007CBA?logo=paypal&style=flat&logoColor=white)](https://www.paypal.com/donate/?hosted_button_id=DZFULJZTP3UQA)
...
[paypal-badge]: https://img.shields.io/badge/Buy%20me%20a%20coffee%20with%20Paypal%20007CBA?logo=paypal&style=flat&logoColor=white
...
您需要一个麦克风：可以使用连接到 HA 的麦克风，或使用 RTP 摄像头的音频流。
...
- config.yaml
可以使用 Filebrowser 插件在 /config/db21ed7f_birdnet-go/config.yaml 文件中配置额外的变量
...
Home Assistant 集成说明可以在 [Birdnet-Go 插件：Home Assistant 集成](./HAINTEGRATION.md) 找到
