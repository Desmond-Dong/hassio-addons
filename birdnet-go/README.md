...
```yaml
ALSA_CARD : 声卡编号（通常是 0 或 1），参见 https://github.com/tphakala/birdnet-go/blob/main/doc/installation.md#deciding-alsa_card-value
...
Home Assistant 集成说明在这里，[Birdnet-Go Addon: Home Assistant Integration](./HAINTEGRATION.md)
