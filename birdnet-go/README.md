...
您需要一个麦克风：要么使用连接到 HA 的麦克风，要么使用 RTSP 摄像机的音频流。
...
COMMAND : realtime --rtsp url # 允许提供鸟网-Go 的参数
```

- Config.yaml
使用 Filebrowser 插件在 /config/db21ed7f_birdnet-go/config.yaml 中找到的 config.yaml 文件配置其他变量
