...
## 描述
当皇家加勒比游轮附加项价格降低时进行通知。可以重新定价游轮，比如饮料套餐、互联网、游览等。
...
```
其中 `eyXXX.eyXXX` 字符串是Home Assistant长期访问令牌。长期访问令牌可以在用户Home Assistant个人资料页面底部的“长期访问令牌”部分创建。
