...
[Grav](https://getgrav.org) 是一个免费的开源内容管理系统（CMS），使用 PHP 编程语言编写，基于 Symfony  Web 应用框架。它使用平面文件数据库作为后端和前端。
这个插件基于以下 Docker 镜像：https://github.com/linuxserver/docker-grav
