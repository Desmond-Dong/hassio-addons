...
Trilium Next Notes 是一个分层笔记应用程序，专注于构建大型个人知识库。 
...
* 笔记可以排列成任意深度的树。单个笔记可以放置在树的多个位置（参见 [克隆](https://triliumnext.github.io/Docs/Wiki/cloning-notes)
* 丰富的所见即所得笔记编辑，包括例如表格、图像和 [数学](https://triliumnext.github.io/Docs/Wiki/text-notes) 以及带 markdown [自动格式化](https://triliumnext.github.io/Docs/Wiki/text-notes#autoformat)
...
* 强大的 [笔记加密](https://triliumnext.github.io/Docs/Wiki/protected-notes) 带每笔记粒度
...
1. 启动插件。
1. 检查插件的日志以查看一切是否正常。
1. 转到你的本地 homeassistant IP:端口 管理端口或 ingress。
1. 按照说明操作
...
Webui 可以在 `<你的ip>:端口` 或 ingress 找到。
