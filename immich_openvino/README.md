...
⚠️ 该项目正在积极开发中。可能会出现错误和更改。请不要将其作为存储照片和视频的唯一方式！ （来自开发者）
...
_感谢所有给我仓库加星的人！要加星请点击下面的图片，然后它将在右上角。谢谢！_
...
基于Web的文件浏览器。
此插件基于来自imagegenius的[docker镜像](https://github.com/imagegenius/docker-immich)。
...
请注意，您需要安装一个单独的postgres插件才能连接数据库。您可以在我的库中安装postgres插件。
请在启动之前更改密码；之后不会更改。

## 支持

在github上创建一个问题，或在[家居助手讨论区](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3)询问。
