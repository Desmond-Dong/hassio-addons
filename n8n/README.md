...
n8n 是一个可扩展的工作流自动化工具。通过公平的代码分发模型，n8n 将始终拥有可见的源代码，可以自行托管，并允许您添加自己的自定义函数、逻辑和应用。n8n 的基于节点的方法使其高度多才多艺，使您能够将任何东西连接到任何其他东西。

功能尚未测试，但插件确实可以运行

_感谢所有星标我的仓库的人！要星标它，请点击下面的图片，它将在右上角。谢谢！_

[![@jdeath/homeassistant-addons 仓库星标者名册](https://reporoster.com/stars/jdeath/homeassistant-addons)](https://github.com/jdeath/homeassistant-addons/stargazers)
