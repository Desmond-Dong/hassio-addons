...
[Autobrr](https://autobrr.com/) autobrr 是现代的 torrent 下载自动化工具。在 trackarr、autodl-irssi 和 flexget 等工具的灵感和想法下，我们构建了一个可以完成所有事情的工具，并且还有更多功能。

这个插件基于 https://github.com/autobrr/autobrr 的 docker 镜像
