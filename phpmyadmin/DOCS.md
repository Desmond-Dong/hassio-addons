...
此 add-on 专为管理官方 Home Assistant MariaDB add-on 而设计。
...
- 此 add-on 创建的目的是允许管理官方 Home assistant MariaDB add-on。它无法连接到其他 MySQL 或 MariaDB 服务器。
