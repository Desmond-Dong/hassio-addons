...
这个插件的安装非常直接，与安装其他 Home Assistant 插件没有什么不同。
...
- 这个插件创建的目的是允许管理官方 Home assistant MariaDB 插件。它不能连接到其他 MySQL 或 MariaDB 服务器。
...
特此免费授予任何获得此软件及其相关文档文件（“软件”）副本的人，在不受限制的情况下处理软件的权利，包括但不限于使用、复制、修改、合并、发布、分发、再许可和/或销售软件副本的权利，并允许向获得软件的人提供这样做，但须遵守以下条件：
