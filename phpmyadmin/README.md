...
一个用于官方MariaDB插件的网页界面。

## 关于

phpMyAdmin是一个用于MySQL & MariaDB的数据库管理工具。常用操作（管理数据库、表格、列、关系、索引、用户、权限等）可以通过用户界面执行，同时您仍然可以直接执行任何SQL语句。

这个插件特别设计用来管理官方的Home Assistant MariaDB插件。
