...
## 60 秒超时
插件包含一个很长的超时。但是，如果您使用另一层代理，例如插件 nginx 代理管理器，它将默认超时为 60 秒。您必须调整代理层以增加超时。更多详情请参阅：https://github.com/portainer/portainer/issues/2953#issuecomment-1235795256
