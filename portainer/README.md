...
Portainer 是一个开源的轻量级管理界面，它允许您轻松管理您的 Docker 主机或 Docker 群集。
...
Portainer 插件非常强大，并几乎可以访问您的整个系统。虽然这个插件是精心创建和维护的，并且考虑了安全性，但在错误或不熟悉的人手中，它可能会损坏您的系统。
...
Webui 可以在 <http://homeassistant:port> 找到，或者在使用 Ingress 的情况下在侧边栏中找到。
默认的用户名/密码：描述在启动日志中。
