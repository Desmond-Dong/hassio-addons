...
实现的变更 : 更新到最新版本；Ingress；SSL；通过插件选项设置密码；允许手动覆盖

_感谢所有星标我的仓库！要星标它，请点击下面的图片，它将出现在右上角。谢谢！_
...
Portainer 插件非常强大，并几乎可以访问你的整个系统。虽然这个插件是精心创建和维护的，并且考虑了安全性，但在错误或不熟悉的人手中，它可能会损坏你的系统。
