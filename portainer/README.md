...
![下载量增长](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/portainer/stats.png)

## 简介

---

Portainer 是一个开源的轻量级管理界面，它允许你轻松管理你的 Docker 主机或 Docker 群集。
...
Portainer 插件非常强大，几乎可以让你访问整个系统。虽然这个插件是经过精心创建和维护的，并且考虑了安全性，但在错误或不熟悉的人手中，它可能会损坏你的系统。
...
Webui 可以在 <http://homeassistant:port> 找到，或在 Ingress 侧边栏中找到。
默认的用户名/密码：在启动日志中描述。
