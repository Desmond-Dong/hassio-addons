...
| `csrf_allowed` | 允许访问应用的地址列表（逗号分隔） | `http://homeassistant.local:8123,https://homeassistant.local:8123` | `http://localhost:8123` |
| `localdisks` | 要挂载的驱动器的硬件名称（逗号分隔） | - | `sda1,sdb1,MYNAS` |
